...
class DDPG(object):
    def __init__(self, num_state, num_action):
        ...
        self.actor_target = Actor(num_state, num_action)
    ...
    def update_parameters(self, minibatch):
        ...
        state_action_batch = self.critic(states, actions)

        value_loss = F.mse_loss(state_action_batch, expected_state_action_values)
...
class Actor(nn.Module):
    def __init__(self,num_state, num_action):
        ...
        self.fc3 = nn.Linear(200,num_action)
...
class Critic(nn.Module):
    def __init__(self,num_state, num_action):
        ...
        self.fc2 = nn.Linear(400 + num_action,400)
