...
class mmWaveChannel:
    ...
    def __init__(self):
        ...
        self.Nc = 1
        self.Ns_peruser = 1
        self.Ns = self.Nu * self.Ns_peruser # 1 data stream per user
        self.Nt = 32  # transmit antennas at BS
        self.Nt_RF = 8
        self.Nr = 4
        self.Nr_RF = 2
    ...
    def generate(self):
        ...
        Nr = self.Nr
        self.H = np.zeros((Nr, Nt * Nu * Nc, Nc), dtype=np.complex128)  # a BS <-> a user Nr X Nt
